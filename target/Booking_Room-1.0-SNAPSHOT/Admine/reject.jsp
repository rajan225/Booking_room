                ...
                <div class="col-sm">
                    ...
                    <div class="row " >
                        ...
                        <div class="col-sm-12 py-4 my-4"style ="min-height: 1000 px; overflow-x: scroll;  " >
                            <div class="row bg-danger sticky-top "><h2 class="text-center text-light">Reject Property</h2></div> 
...
//            String userid=session.getAttribute("userid").toString();
            ...
            ResultSet rs=dm.select("select * from properties where status='Reject'" );
            int i=1;
            while(rs.next())
            {
            %>

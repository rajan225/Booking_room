...
/*    .container-flude {
    ...
    <body>
            ...
            ResultSet rs=dm.select("select * from booked where tmobile='"+userid+"'");
            while(rs.next())
            {
            %>
              ...
              <tr>
                                    ...
                                    <td><%=rs.getString("lmobile")%></td>
                                    <td><%=rs.getString("cdate")%></td>
                                    <td><%=rs.getString("date")%></td>
                                    <td><%=rs.getString("status")%></td>
                                    <td><%=rs.getString("about")%></td>                         
  <td><a class="btn btn-primary" href="payment.jsp?id=<%=rs.getString("id")%>"> <%=rs.getString("payment")%> </a> </td>

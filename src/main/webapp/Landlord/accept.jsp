...
/*    .container-flude {
    ...
    <body>
             ...
             <div class="container-flude">
                 ...
                 <div class="row" style="overflow-x: scroll;">
                        ...
                        <div class="col-sm py-4 my-4" style="box-shadow: 5px 5px 10px 5px black;overflow-x: scroll; ">
                            <div class="row bg-danger"><h2 class="text-center text-light">Approved order</h2></div> 
            ...
            ResultSet rs=dm.select("select * from booked where lmobile='"+userid+"' and status='Accepted'");
            while(rs.next())
            {
            %>

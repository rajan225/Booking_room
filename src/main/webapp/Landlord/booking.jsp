...
/*    .container-flude {
    ...
    <body>
                ...
                <div class="col-sm">
                 ...
                 <div class="row" style="overflow-y: scroll;">
                        ...
                        <div class="col-sm py-4 my-4" style="box-shadow: 5px 5px 10px 5px black;overflow-x: scroll; ">
                            <div class="row bg-danger"><h2 class="text-center text-light">Fast Booking History</h2></div> 
            ...
            ResultSet r=dm.select("select * from booked where lmobile='"+useri+"' and name='fast booking'");
            while(r.next())
            {
            %>
            
              <tr>
                                    <td><%=r.getString("roomid")%></td>
                                    <td><img src='../properties/<%=r.getString("image")%>'height='200px'width='200px'</td>
                                    <td><%=r.getString("name")%></td>
                                    <td><%=r.getString("price")%></td>
                                    <td><%=r.getString("search")%></td>
                                    <td><%=r.getString("location")%></td>
                                    <td><%=r.getString("tmobile")%></td>
                                    <td><%=r.getString("cdate")%></td>
                                    <td><%=r.getString("date")%></td>
                                    <td><%=r.getString("status")%></td>
                                    <td><%=r.getString("about")%></td>
                                    <td><%=r.getString("payment")%></td>
                    <td><a class="btn btn-outline-success mt-2 "href="acceptorder.jsp?id=<%=r.getString("id")%>">ACCEPT</a>
                                   <a class="btn btn-outline-danger mt-2 " href="rejectorder.jsp?id=<%=r.getString("id")%>">REJECT</a></td> 
             ...
             <div class="container-flude">
                 ...
                 <div class="row" style="overflow-y: scroll;">
                        ...
                        <div class="col-sm py-4 my-4" style="box-shadow: 5px 5px 10px 5px black;overflow-x: scroll; ">
                            <div class="row bg-danger"><h2 class="text-center text-light">Booking History</h2></div> 
                            <table class="table table-bordered">
